...
function Register() {
  const [currentOperation, setCurrentOperation] = useState<"login" | "signup">(
    "login"
  );
  return (
    <main className="min-h-screen w-full flex items-center justify-center">
      <div className="hidden relative lg:flex w-1/2 h-screen p-5">
        <figure className="relative flex w-full h-full rounded-xl shadow-sm overflow-hidden after:content-[''] after:absolute after:inset-0 after:bg-sky-600 after:bg-opacity-50">
          <img
