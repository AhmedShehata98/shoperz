  ...
  return (
    <div className=" p-4 border-Grey-200 group border-[1px] hover:border-transparent hover:shadow-md rounded">
      ...
      <div className="flex justify-between items-center py-2">
        <span>{price}</span>
        <div className="">
          <button className="p-3 group-hover:bg-Primary-600 transition-all duration-300 bg-slate-200 rounded-full">
            <svg
              width="16"
              height="16"
              viewBox="0 0 16 16"
          ...
          {/* <button className="p-3 group-hover:bg-red-800 duration-900 transition-all  bg-slate-200 rounded-full group-hover:-translate-y-14">
            <svg
              width="18"
              height="16"
              viewBox="0 0 18 16"
          ...
          <button className="p-3  group-hover:bg-red-800 transition-all duration-300 bg-slate-200 rounded-full">
            <svg
              width="18"
              height="16"
              viewBox="0 0 18 16"
