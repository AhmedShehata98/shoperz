    ...
    <div className="container pb-10 mx-auto">
      <div className="flex justify-between items-center py-6">
        ...
        <div className="flex gap-x-3">
          <button
            className={`swiper-prev w-8 h-7 flex items-center justify-center shadow-sm rounded-md bg-Grey-100 ${
              isStartOfList ? "!bg-white" : ""
            }`}
          >
            <svg
              width="15"
              ...
              className={`${isStartOfList ? "opacity-40" : ""}`}
            >
              <path
          ...
          <button
            className={`swiper-next w-8 h-7 flex items-center justify-center shadow-sm rounded-md bg-Grey-100 ${
              isEndOfList ? "!bg-white" : ""
            }`}
          >
            <svg
              width="15"
              ...
              fill="none"
              xmlns="http://www.w3.org/2000/svg"
              className={`${isEndOfList ? "!opacity-40" : ""}`}
            >
              <path
